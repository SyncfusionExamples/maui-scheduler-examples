...
namespace RecurringSchedulerAppointment
{
    ...
    public class SchedulerViewModel
    {
        ...
        /// </summary>
        public ObservableCollection<Syncfusion.Maui.Scheduler.SchedulerAppointment>? RecursiveExceptionEvents { get; set; }
        ...
        {
            this.RecursiveExceptionEvents = new ObservableCollection<Syncfusion.Maui.Scheduler.SchedulerAppointment>();
            ...
            var changedEvent = new Syncfusion.Maui.Scheduler.SchedulerAppointment
            {
            ...
            var changedEvent1 = new Syncfusion.Maui.Scheduler.SchedulerAppointment
            {
                Subject = "Scrum meeting - Changed Occurrence",
