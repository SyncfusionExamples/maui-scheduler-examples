...
namespace SchedulerAppointment
{
    ...
    public class RecurringAppointmentViewModel
    {
        ...
        /// </summary>
        public ObservableCollection<Syncfusion.Maui.Scheduler.SchedulerAppointment> RecursiveEvents { get; set; } = new ObservableCollection<Syncfusion.Maui.Scheduler.SchedulerAppointment>();
        ...
        {
            this.RecursiveEvents = new ObservableCollection<Syncfusion.Maui.Scheduler.SchedulerAppointment>();
            Random ran = new Random();
            DateTime currentDate = DateTime.Now.AddMonths(-1);

            var dailyEvent = new Syncfusion.Maui.Scheduler.SchedulerAppointment
            {
            ...
            var weeklyEvent = new Syncfusion.Maui.Scheduler.SchedulerAppointment
            {
            ...
            var monthlyEvent = new Syncfusion.Maui.Scheduler.SchedulerAppointment
            {
            ...
            var yearlyEvent = new Syncfusion.Maui.Scheduler.SchedulerAppointment
            {
